# Graph Report - cucina  (2026-08-14)

## Corpus Check
- 83 files · ~97,401 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1252 nodes · 1612 edges · 125 communities (117 shown, 8 thin omitted)
...
7. `attribute_reading()` - 11 edges
8. `_safe()` - 10 edges
9. `ha_frontmatter()` - 10 edges
10. `dividi()` - 10 edges

## Surprising Connections (you probably didn't know these)
- `oracle_cast()` --calls--> `cast_reading()`  [INFERRED]
  server/brain_core.py → training/aion/tools/oracle_cast.py
- `oracle_hexagram()` --calls--> `get_hexagram()`  [INFERRED]
  server/brain_core.py → training/aion/tools/oracle_cast.py
...
Cohesion: 0.13
Nodes (9): collega(), Aggiunge un arco tra due FILE se entrambi sono nodi del grafo., dentro(), Percorso dentro il brain attivo. Comodita' per non ripetere il join., Forza stdout/stderr in UTF-8, sostituendo cio' che non e' rappresentabile., usa_utf8(), _lista(), main() (+1 more)
...
Cohesion: 0.08
Nodes (24): La prova che conta: un brain nuovo nasce da core/, si configura e la sua     pip, Con un brain solo si intuisce; con due, una porta che non lo dice e' una     tra, La funzione che costruisce l'elenco deve reggere sia il caso a un brain     (nes, Un prodotto che al primo avvio segnala contenuto gia' scaduto insegna a     igno, core/ e brains/ sono artefatti e istanze: nel grafo del brain non ci vanno., L'ordine conta: se la potatura arrivasse dopo le viste o l'indice, quelli     av, I percorsi del contenuto passano da tools/brain.py: e' il punto unico che     pe, La regressione da impedire: un tool nuovo che scrive os.path.join(ROOT, 'wiki') (+16 more)
...
Cohesion: 0.33
Nodes (6): Prudenza sui nodi corti/numerici (es. '6'): il confronto per sottostringa     ma, Un nodo 'sql' non deve marchiare 'postgresql': l'annotazione sarebbe     credibi, test_memoria_non_annota_per_nodi_numerici_corti(), test_memoria_non_attribuisce_per_sottostringa(), _corrisponde(), Un nodo citato da una lezione si riferisce a questo risultato?      Prudenza vol
...
## Knowledge Gaps
- **551 isolated node(s):** `$schema`, `title`, `description`, `type`, `required` (+546 more)
...
- **Why does `come_testo()` connect `Community 10` to `Community 0`, `Community 3`, `Community 7`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `usa_utf8()` connect `Community 2` to `Community 5`, `Community 10`, `Community 12`, `Community 13`, `Community 15`, `Community 19`, `Community 26`, `Community 27`, `Community 31`, `Community 33`, `Community 35`, `Community 100`, `Community 101`, `Community 102`, `Community 103`, `Community 104`, `Community 108`, `Community 115`, `Community 116`, `Community 119`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `17. 隨 Il Seguimento (Suí) ䷐` connect `Community 43` to `Community 23`?**
