# Graph Report - aion  (2026-08-15)

## Corpus Check
- 271 files · ~290,182 words
...
6. `cerca_con_diagnosi()` - 14 edges
7. `analyze()` - 11 edges
8. `attribute_reading()` - 11 edges
9. `_safe()` - 10 edges
10. `ha_frontmatter()` - 10 edges

## Surprising Connections (you probably didn't know these)
- `test_attribuzione_senza_mobili_e_range()` --calls--> `attribute_reading()`  [INFERRED]
  tests/test_tools.py → training/aion/tools/oracle_cast.py
- `testo_da_file()` --calls--> `dividi()`  [EXTRACTED]
  plugins/scrittura/tools/style_check.py → tools/frontmatter.py
- `main()` --calls--> `usa_utf8()`  [EXTRACTED]
  plugins/scrittura/tools/style_check.py → tools/console.py
...
Cohesion: 0.11
Nodes (8): collega(), Aggiunge un arco tra due FILE se entrambi sono nodi del grafo., dentro(), Percorso dentro il brain attivo. Comodita' per non ripetere il join., Forza stdout/stderr in UTF-8, sostituendo cio' che non e' rappresentabile., usa_utf8(), Scrive una pagina: corpo + lista 'Collegati:' (niente sotto-heading -> niente no, w()
...
Cohesion: 0.09
Nodes (20): La prova che conta: un brain nuovo nasce da core/, si configura e la sua     pip, Con un brain solo si intuisce; con due, una porta che non lo dice e' una     tra, La funzione che costruisce l'elenco deve reggere sia il caso a un brain     (nes, DIFETTO REALE: dentro un'istanza BRAIN e ROOT coincidono, quindi il confronto, Un selettore che offre porte inesistenti e' peggio di nessun selettore., DIFETTO REALE: graph_health chiedeva a git 'HEAD~1:graphify-out/graph.json',, core/ e brains/ sono artefatti e istanze: nel grafo del brain non ci vanno., L'ordine conta: se la potatura arrivasse dopo le viste o l'indice, quelli     av (+12 more)
...
Cohesion: 0.18
Nodes (8): _file(), graph(), graph_compact(), model(), reasoner(), view_atlas(), view_compact(), view_extended()
...
Cohesion: 0.18
Nodes (13): Difetto reale: una nota che inizia con '--- FUNZIONI ... ---' veniva scambiata, Dopo la correzione del parser, nessuna nota deve restare scoperta., test_frontmatter_apertura_senza_chiusura(), test_frontmatter_non_confonde_una_riga_di_testo(), test_frontmatter_riconosce_il_blocco_valido(), test_tutte_le_note_raw_hanno_provenienza(), dividi(), e_generato() (+5 more)
...
Cohesion: 0.15
Nodes (13): Response, affected(), context(), _err(), explain(), inbox_done(), inbox_read(), oracle_hexagram() (+5 more)
...
Cohesion: 0.26
Nodes (11): test_resurface_sceglie_con_criterio_e_esclude_i_generati(), candidati(), _frontmatter(), _gradi_per_file(), main(), Le piu meritevoli, ma variando: si prende dal gruppo di testa ruotando in base, Aggiorna 'reviewed' a oggi: e cosi che la nota esce dalla coda., Parser condiviso (tools/frontmatter). (+3 more)
...
Cohesion: 0.33
Nodes (6): BaseModel, capture(), CaptureReq, Feedback, oracle(), OracleReq

### Community 204 - "Community 204"
Cohesion: 0.33
Nodes (5): Aggiungere una nuova macroarea, Front-matter standard (convenzione del brain), Macroaree attive, raw/ — materiale grezzo per macroarea, Regole

### Community 205 - "Community 205"
Cohesion: 0.33
Nodes (6): Un prodotto che al primo avvio segnala contenuto gia' scaduto insegna a     igno, test_un_brain_vergine_non_si_lamenta_al_primo_avvio(), Bi-temporalita: valid_until nel passato -> il fatto risulta scaduto.     Ora il, test_freshness_rileva_fatto_scaduto(), leggi(), (meta, corpo) da file. (None, '') se illeggibile.
...
Cohesion: 0.50
Nodes (4): I percorsi del contenuto passano da tools/brain.py: e' il punto unico che     pe, test_il_motore_risolve_il_brain_invece_di_presumerlo(), brain_root(), La cartella che contiene raw/, wiki/, engine/, areas.json di QUESTO brain.
...
## Knowledge Gaps
- **1367 isolated node(s):** `$schema`, `title`, `description`, `type`, `required` (+1362 more)
...
- **Why does `come_testo()` connect `Community 13` to `Community 25`, `Community 10`, `Community 3`, `Community 45`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `usa_utf8()` connect `Community 2` to `Community 0`, `Community 132`, `Community 13`, `Community 18`, `Community 19`, `Community 22`, `Community 43`, `Community 48`, `Community 49`, `Community 57`, `Community 61`, `Community 202`, `Community 206`, `Community 207`, `Community 216`, `Community 228`, `Community 229`, `Community 232`, `Community 235`, `Community 236`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `11. 泰 La Pace (Tài) ䷊` connect `Community 65` to `Community 36`?**
