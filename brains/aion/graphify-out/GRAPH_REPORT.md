...
## Corpus Check
- 203 files · ~195,321 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1201 nodes · 1470 edges · 152 communities (134 shown, 18 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `91a42e3b`
...
3. `Sistema anti-AI e regole dell'italiano` - 10 edges
4. `Antologia della voce — il modello positivo` - 9 edges
5. `$ref` - 8 edges
6. `1. 乾 Il Creativo (Qián) ䷀` - 8 edges
7. `2. 坤 Il Ricettivo (Kūn) ䷁` - 8 edges
8. `3. 屯 Difficoltà Iniziale (Zhūn) ䷂` - 8 edges
9. `4. 蒙 L'Inesperienza (Méng) ䷃` - 8 edges
10. `5. 需 L'Attesa (Xū) ䷄` - 8 edges
...
Cohesion: 0.07
Nodes (36): Algebra relazionale, Analisi esplorativa (EDA), Analisi relazionale (confronti tra variabili), Cloud computing, Controlli di qualita dei dati (data quality), Data cleaning, Data-driven culture, Data storytelling (+28 more)
...
Cohesion: 0.12
Nodes (16): 11. 泰 La Pace (Tài) ䷊, 1. 乾 Il Creativo (Qián) ䷀, Giudizio, Giudizio, Immagine, Immagine, Interpretazione Moderna, Interpretazione Moderna (+8 more)
...
## Knowledge Gaps
- **828 isolated node(s):** `$schema`, `title`, `description`, `type`, `required` (+823 more)
...
- **Why does `4. 蒙 L'Inesperienza (Méng) ䷃` connect `Community 107` to `Community 0`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `48. 井 Il Pozzo (Jǐng) ䷯` connect `Community 105` to `Community 0`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `1. 乾 Il Creativo (Qián) ䷀` connect `Community 65` to `Community 0`?**
