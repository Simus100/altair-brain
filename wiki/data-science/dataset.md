...
- Social media: `Analisi Dati Social Media/`
- Hotel: `Analisi prenotazioni hotel/` (hotel_booking*.xlsx, .csv)
- Olist: `Brazilian E-Commerce Olist/dataset elements/` (9 CSV olist_*), report .pbix
- Insurance: `Insurance Analysis/` (insurance.csv, .xlsx)
