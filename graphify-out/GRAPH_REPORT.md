...
5. `2. 坤 Il Ricettivo (Kūn) ䷁` - 8 edges
6. `3. 屯 Difficoltà Iniziale (Zhūn) ䷂` - 8 edges
7. `4. 蒙 L'Inesperienza (Méng) ䷃` - 8 edges
8. `5. 需 L'Attesa (Xū) ䷄` - 8 edges
9. `6. 訟 Il Conflitto (Sòng) ䷅` - 8 edges
10. `7. 師 L'Esercito (Shī) ䷆` - 8 edges
