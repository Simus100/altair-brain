...
## Corpus Check
- 81 files · ~39,460 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 712 nodes · 849 edges · 86 communities (82 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f0be8e58`
...
## Knowledge Gaps
- **553 isolated node(s):** `graphify`, `Workflow: graphify`, `Come procedere`, `Vincoli`, `Output atteso` (+548 more)
...
- **Why does `3. 屯 Difficoltà Iniziale (Zhūn) ䷂` connect `Community 41` to `Community 0`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **What connects `Mappa un nodo originale al suo nodo compatto.`, `graphify`, `Workflow: graphify` to the rest of the system?**
