...
**L'avvertenza che l'autore mette per iscritto** e che vale piu' della tassonomia:
il sistema e' usato in psicologia, PNL, esoterismo e nel mondo aziendale, e in questi
passaggi **rischia la distorsione del significato intrinseco**. Chi lo porta nella
scrittura ha lo stesso rischio: usare i nove tipi come etichette invece che come
visioni del mondo.

- Etimologia: *ennea* (nove) + *gramma* (segno). Figura: «stella a nove punte
  inscritta in un cerchio».
- Origini datate a ~2500 anni fa, difficili da individuare con precisione.
- Diffusione moderna: **Ivanovitch Gurdijieff**; poi **J. Bennett**, **Oscar Ichazo**,
  **Claudio Naranio**.
- **Un elemento dominante nella personalità**, con caratteristiche che variano nel
  tempo — non una gabbia fissa. E' il punto che rende il modello utile a un
  personaggio che deve cambiare nell'arco di un romanzo.
- **I nove tipi come li nomina l'articolo**: 1 Perfezionista, 2 Altruista, 3 Manager,
  4 Romantico, 5 Eremita, 6 Scettico, 7 Artista, 8 Capo, 9 Diplomatico.
